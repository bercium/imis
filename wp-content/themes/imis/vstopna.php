...
<div id="featured" class="inside container" >
      <ul id="controls" class="ui-tabs-nav flex-control-nav flex-control-thumbs">  
          ...
          <li class="ui-tabs-nav-item" id="nav-fragment-2"><a href="#fragment-2"><span><div class="thumbnail-slika thumbnail-slika-2"></div><?php the_field('thumbnail-tekst-2'); ?></a></span></li>  
          <li class="ui-tabs-nav-item" id="nav-fragment-3"><a href="#fragment-3"><span><div class="thumbnail-slika thumbnail-slika-3"></div><?php the_field('thumbnail-tekst-3'); ?></a></span></li>  
